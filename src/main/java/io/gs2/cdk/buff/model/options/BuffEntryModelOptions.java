...
public class BuffEntryModelOptions {
    ...
    public BuffEntryModelOptions withMetadata(
        String metadata
    ) {
    ...
    public BuffEntryModelOptions withTargetModel(
    ...
    public BuffEntryModelOptions withTargetAction(
    ...
    public BuffEntryModelOptions withApplyPeriodScheduleEventId(
        String applyPeriodScheduleEventId
    ) {
