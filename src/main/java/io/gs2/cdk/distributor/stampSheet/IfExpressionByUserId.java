 ...
 */
package io.gs2.cdk.distributor.stampSheet;
...
public class IfExpressionByUserId extends VerifyAction {
    ...
    public IfExpressionByUserId(
        ...
        List<ConsumeAction> trueActions,
        List<ConsumeAction> falseActions,
            ...
            new HashMap<>() {
                {
                    ...
                    put("trueActions", trueActions);
                    put("falseActions", falseActions);
