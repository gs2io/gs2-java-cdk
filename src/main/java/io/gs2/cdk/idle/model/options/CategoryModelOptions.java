...
public class CategoryModelOptions {
    ...
    public CategoryModelOptions withIdlePeriodScheduleId(
        String idlePeriodScheduleId
    ) {
        this.idlePeriodScheduleId = idlePeriodScheduleId;
        return this;
    }
    
    public CategoryModelOptions withReceivePeriodScheduleId(
        String receivePeriodScheduleId
    ) {
