...
public class RateModelOptions {
    ...
    public RateModelOptions withDescription(
        String description
    ) {
    ...
    public RateModelOptions withAcquireExperienceHierarchy(
        List<String> acquireExperienceHierarchy
    ) {
        this.acquireExperienceHierarchy = acquireExperienceHierarchy;
        return this;
    }
    
    public RateModelOptions withBonusRates(
        List<BonusRate> bonusRates
    ) {
