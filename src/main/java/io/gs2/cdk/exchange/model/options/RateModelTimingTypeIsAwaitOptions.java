...
public class RateModelTimingTypeIsAwaitOptions {
    ...
    public RateModelTimingTypeIsAwaitOptions withVerifyActions(
    ...
    public RateModelTimingTypeIsAwaitOptions withConsumeActions(
    ...
    public RateModelTimingTypeIsAwaitOptions withAcquireActions(
