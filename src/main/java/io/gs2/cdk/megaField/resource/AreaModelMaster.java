...
public class AreaModelMaster extends CdkResource {
    ...
    public AreaModelMaster(
        ...
        super("MegaField_AreaModelMaster_" + name);
    ...
    public GetAttr getAttrAreaModelMasterId() {
        return new GetAttr(
