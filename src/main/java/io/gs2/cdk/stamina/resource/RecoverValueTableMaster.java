...
public class RecoverValueTableMaster extends CdkResource {
    ...
    public RecoverValueTableMaster(
        ...
        super("Stamina_RecoverValueTableMaster_" + name);
    ...
    public RecoverValueTableMasterRef ref(
            String namespaceName
    ) {
    ...
    public GetAttr getAttrRecoverValueTableId() {
        return new GetAttr(
