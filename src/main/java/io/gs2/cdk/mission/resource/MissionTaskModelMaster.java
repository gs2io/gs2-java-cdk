...
public class MissionTaskModelMaster extends CdkResource {
    ...
    public MissionTaskModelMaster(
        ...
        super("Mission_MissionTaskModelMaster_" + name);
    ...
    public Map<String, Object> properties() {
        ...
        if (this.missionGroupName != null) {
            properties.put("MissionGroupName", this.missionGroupName);
        }
        if (this.name != null) {
