...
public class MissionTaskModelVerifyCompleteTypeIsConsumeActionsOptions {
    ...
    public MissionTaskModelVerifyCompleteTypeIsConsumeActionsOptions withMetadata(
        String metadata
    ) {
    ...
    public MissionTaskModelVerifyCompleteTypeIsConsumeActionsOptions withVerifyCompleteConsumeActions(
    ...
    public MissionTaskModelVerifyCompleteTypeIsConsumeActionsOptions withCompleteAcquireActions(
    ...
    public MissionTaskModelVerifyCompleteTypeIsConsumeActionsOptions withChallengePeriodEventId(
    ...
    public MissionTaskModelVerifyCompleteTypeIsConsumeActionsOptions withPremiseMissionTaskName(
    ...
    public MissionTaskModelVerifyCompleteTypeIsConsumeActionsOptions withTargetResetType(
