...
public class MissionGroupModelResetTypeIsDailyOptions {
    public String metadata;
    public List<MissionTaskModel> tasks;
    public String completeNotificationNamespaceId;
    
    public MissionGroupModelResetTypeIsDailyOptions withMetadata(
        String metadata
    ) {
    ...
    public MissionGroupModelResetTypeIsDailyOptions withTasks(
    ...
    public MissionGroupModelResetTypeIsDailyOptions withCompleteNotificationNamespaceId(
