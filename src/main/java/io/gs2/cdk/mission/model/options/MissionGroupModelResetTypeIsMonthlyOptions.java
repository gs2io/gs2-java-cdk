...
public class MissionGroupModelResetTypeIsMonthlyOptions {
    public String metadata;
    public List<MissionTaskModel> tasks;
    public String completeNotificationNamespaceId;
    
    public MissionGroupModelResetTypeIsMonthlyOptions withMetadata(
        String metadata
    ) {
    ...
    public MissionGroupModelResetTypeIsMonthlyOptions withTasks(
    ...
    public MissionGroupModelResetTypeIsMonthlyOptions withCompleteNotificationNamespaceId(
