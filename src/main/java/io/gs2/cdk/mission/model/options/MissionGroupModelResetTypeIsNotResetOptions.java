...
public class MissionGroupModelResetTypeIsNotResetOptions {
    public String metadata;
    public List<MissionTaskModel> tasks;
    public String completeNotificationNamespaceId;
    
    public MissionGroupModelResetTypeIsNotResetOptions withMetadata(
        String metadata
    ) {
    ...
    public MissionGroupModelResetTypeIsNotResetOptions withTasks(
    ...
    public MissionGroupModelResetTypeIsNotResetOptions withCompleteNotificationNamespaceId(
