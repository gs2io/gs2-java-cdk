...
public class EventRepeatTypeIsDailyOptions {
    public String metadata;
    public Long absoluteBegin;
    public Long absoluteEnd;
    
    public EventRepeatTypeIsDailyOptions withMetadata(
        String metadata
    ) {
    ...
    public EventRepeatTypeIsDailyOptions withAbsoluteBegin(
        Long absoluteBegin
    ) {
    ...
    public EventRepeatTypeIsDailyOptions withAbsoluteEnd(
        Long absoluteEnd
    ) {
