...
public class BonusModelOptions {
    ...
    public BonusModelOptions withPeriodEventId(
    ...
    public BonusModelOptions withResetHour(
        Integer resetHour
    ) {
    ...
    public BonusModelOptions withRepeat(
    ...
    public BonusModelOptions withRewards(
        List<Reward> rewards
    ) {
    ...
    public BonusModelOptions withMissedReceiveReliefConsumeActions(
