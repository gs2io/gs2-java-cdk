...
public class BonusModelMissedReceiveReliefIsDisabledOptions {
    ...
    public BonusModelMissedReceiveReliefIsDisabledOptions withMetadata(
        String metadata
    ) {
    ...
    public BonusModelMissedReceiveReliefIsDisabledOptions withPeriodEventId(
    ...
    public BonusModelMissedReceiveReliefIsDisabledOptions withRewards(
        List<Reward> rewards
    ) {
    ...
    public BonusModelMissedReceiveReliefIsDisabledOptions withMissedReceiveReliefVerifyActions(
    ...
    public BonusModelMissedReceiveReliefIsDisabledOptions withMissedReceiveReliefConsumeActions(
