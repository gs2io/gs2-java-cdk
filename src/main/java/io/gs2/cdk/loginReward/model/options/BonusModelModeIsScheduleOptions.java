...
public class BonusModelModeIsScheduleOptions {
    ...
    public BonusModelModeIsScheduleOptions withMetadata(
        String metadata
    ) {
    ...
    public BonusModelModeIsScheduleOptions withPeriodEventId(
    ...
    public BonusModelModeIsScheduleOptions withRewards(
        List<Reward> rewards
    ) {
    ...
    public BonusModelModeIsScheduleOptions withMissedReceiveReliefVerifyActions(
    ...
    public BonusModelModeIsScheduleOptions withMissedReceiveReliefConsumeActions(
