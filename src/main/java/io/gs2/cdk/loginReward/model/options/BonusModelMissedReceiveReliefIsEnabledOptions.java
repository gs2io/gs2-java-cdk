...
public class BonusModelMissedReceiveReliefIsEnabledOptions {
    ...
    public BonusModelMissedReceiveReliefIsEnabledOptions withMetadata(
        String metadata
    ) {
    ...
    public BonusModelMissedReceiveReliefIsEnabledOptions withPeriodEventId(
    ...
    public BonusModelMissedReceiveReliefIsEnabledOptions withRewards(
        List<Reward> rewards
    ) {
    ...
    public BonusModelMissedReceiveReliefIsEnabledOptions withMissedReceiveReliefVerifyActions(
    ...
    public BonusModelMissedReceiveReliefIsEnabledOptions withMissedReceiveReliefConsumeActions(
