...
public class BlockingPolicyModelHostingProviderIpDetectionIsEnableOptions {
    public List<String> ipAddresses;
    
    public BlockingPolicyModelHostingProviderIpDetectionIsEnableOptions withIpAddresses(
