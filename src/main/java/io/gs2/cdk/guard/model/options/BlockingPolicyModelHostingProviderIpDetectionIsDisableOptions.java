...
public class BlockingPolicyModelHostingProviderIpDetectionIsDisableOptions {
    public List<String> ipAddresses;
    
    public BlockingPolicyModelHostingProviderIpDetectionIsDisableOptions withIpAddresses(
