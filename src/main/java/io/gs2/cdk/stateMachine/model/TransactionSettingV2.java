...
import io.gs2.cdk.stateMachine.model.options.TransactionSettingV2Options;
...
public class TransactionSettingV2 {
    ...
    public TransactionSettingV2(
        ...
        TransactionSettingV2Options options
    ) {
    ...
    public Map<String, Object> properties(
        ...
        if (this.enableParallelExecution != null) {
            properties.put("enableParallelExecution", this.enableParallelExecution);
        }
