...
public class CurrentMasterData extends CdkResource {
    ...
    String version = "2019-01-11";
    public String namespaceName;
    public List<ExperienceModel> experienceModels;
        ...
        return new HashMap<>() {
            {
                ...
                put("Settings", new HashMap<>() {
                    {
                        put("version", version);
                        put("experienceModels", experienceModels.stream().map(ExperienceModel::properties).collect(Collectors.toList()));
                    }
                });
            }
        };
