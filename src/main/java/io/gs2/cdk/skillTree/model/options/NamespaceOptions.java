...
import io.gs2.cdk.skillTree.model.TransactionSettingV2;
...
public class NamespaceOptions {
    ...
    public NamespaceOptions withReleaseScript(
        ScriptSetting releaseScript
    ) {
        this.releaseScript = releaseScript;
        return this;
    }
    
    public NamespaceOptions withRestrainScript(
        ScriptSetting restrainScript
    ) {
