...
public class NodeModelOptions {
    ...
    public NodeModelOptions withMetadata(
        String metadata
    ) {
    ...
    public NodeModelOptions withReturnAcquireActions(
    ...
    public NodeModelOptions withPremiseNodeNames(
        List<String> premiseNodeNames
    ) {
