...
public class NamespaceCompleteMatchmakingTriggerTypeIsGs2RealtimeOptions {
    ...
    public NamespaceCompleteMatchmakingTriggerTypeIsGs2RealtimeOptions withTransactionSetting(
    ...
    public NamespaceCompleteMatchmakingTriggerTypeIsGs2RealtimeOptions withTransactionSettingV2(
    ...
    public NamespaceCompleteMatchmakingTriggerTypeIsGs2RealtimeOptions withRevision(
        Long revision
    ) {
