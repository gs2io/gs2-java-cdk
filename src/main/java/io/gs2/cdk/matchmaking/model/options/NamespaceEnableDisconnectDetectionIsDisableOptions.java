...
public class NamespaceEnableDisconnectDetectionIsDisableOptions {
    ...
    public NamespaceEnableDisconnectDetectionIsDisableOptions withDescription(
        String description
    ) {
    ...
    public NamespaceEnableDisconnectDetectionIsDisableOptions withTransactionSettingV2(
    ...
    public NamespaceEnableDisconnectDetectionIsDisableOptions withChangeRatingScript(
    ...
    public NamespaceEnableDisconnectDetectionIsDisableOptions withJoinNotification(
    ...
    public NamespaceEnableDisconnectDetectionIsDisableOptions withLeaveNotification(
    ...
    public NamespaceEnableDisconnectDetectionIsDisableOptions withCompleteNotification(
    ...
    public NamespaceEnableDisconnectDetectionIsDisableOptions withChangeRatingNotification(
    ...
    public NamespaceEnableDisconnectDetectionIsDisableOptions withLogSetting(
    ...
    public NamespaceEnableDisconnectDetectionIsDisableOptions withRevision(
        Long revision
    ) {
