...
public class NamespaceCreateGatheringTriggerTypeIsGs2ScriptOptions {
    ...
    public NamespaceCreateGatheringTriggerTypeIsGs2ScriptOptions withTransactionSetting(
    ...
    public NamespaceCreateGatheringTriggerTypeIsGs2ScriptOptions withTransactionSettingV2(
    ...
    public NamespaceCreateGatheringTriggerTypeIsGs2ScriptOptions withChangeRatingScript(
    ...
    public NamespaceCreateGatheringTriggerTypeIsGs2ScriptOptions withJoinNotification(
    ...
    public NamespaceCreateGatheringTriggerTypeIsGs2ScriptOptions withLeaveNotification(
    ...
    public NamespaceCreateGatheringTriggerTypeIsGs2ScriptOptions withCompleteNotification(
    ...
    public NamespaceCreateGatheringTriggerTypeIsGs2ScriptOptions withChangeRatingNotification(
    ...
    public NamespaceCreateGatheringTriggerTypeIsGs2ScriptOptions withLogSetting(
