...
public class NamespaceCreateGatheringTriggerTypeIsNoneOptions {
    ...
    public NamespaceCreateGatheringTriggerTypeIsNoneOptions withTransactionSetting(
    ...
    public NamespaceCreateGatheringTriggerTypeIsNoneOptions withTransactionSettingV2(
