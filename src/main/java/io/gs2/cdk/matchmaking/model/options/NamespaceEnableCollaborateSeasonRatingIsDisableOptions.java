...
public class NamespaceEnableCollaborateSeasonRatingIsDisableOptions {
    ...
    public NamespaceEnableCollaborateSeasonRatingIsDisableOptions withDescription(
        String description
    ) {
    ...
    public NamespaceEnableCollaborateSeasonRatingIsDisableOptions withTransactionSetting(
    ...
    public NamespaceEnableCollaborateSeasonRatingIsDisableOptions withTransactionSettingV2(
    ...
    public NamespaceEnableCollaborateSeasonRatingIsDisableOptions withChangeRatingScript(
    ...
    public NamespaceEnableCollaborateSeasonRatingIsDisableOptions withJoinNotification(
    ...
    public NamespaceEnableCollaborateSeasonRatingIsDisableOptions withLeaveNotification(
    ...
    public NamespaceEnableCollaborateSeasonRatingIsDisableOptions withCompleteNotification(
    ...
    public NamespaceEnableCollaborateSeasonRatingIsDisableOptions withChangeRatingNotification(
    ...
    public NamespaceEnableCollaborateSeasonRatingIsDisableOptions withLogSetting(
    ...
    public NamespaceEnableCollaborateSeasonRatingIsDisableOptions withRevision(
        Long revision
    ) {
