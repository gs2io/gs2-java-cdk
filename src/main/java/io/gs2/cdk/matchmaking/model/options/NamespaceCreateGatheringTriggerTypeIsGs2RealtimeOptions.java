...
public class NamespaceCreateGatheringTriggerTypeIsGs2RealtimeOptions {
    ...
    public NamespaceCreateGatheringTriggerTypeIsGs2RealtimeOptions withTransactionSetting(
    ...
    public NamespaceCreateGatheringTriggerTypeIsGs2RealtimeOptions withTransactionSettingV2(
    ...
    public NamespaceCreateGatheringTriggerTypeIsGs2RealtimeOptions withChangeRatingScript(
    ...
    public NamespaceCreateGatheringTriggerTypeIsGs2RealtimeOptions withJoinNotification(
    ...
    public NamespaceCreateGatheringTriggerTypeIsGs2RealtimeOptions withLeaveNotification(
    ...
    public NamespaceCreateGatheringTriggerTypeIsGs2RealtimeOptions withCompleteNotification(
    ...
    public NamespaceCreateGatheringTriggerTypeIsGs2RealtimeOptions withLogSetting(
