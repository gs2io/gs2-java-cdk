...
import io.gs2.cdk.money2.model.options.WithdrawEventOptions;
...
public class WithdrawEvent {
    ...
    private List<DepositTransaction> withdrawDetails = null;

    public WithdrawEvent(
        Integer slot,
        WalletSummary status,
        WithdrawEventOptions options
    ) {
        this.slot = slot;
        this.status = status;
    ...
    public Map<String, Object> properties(
        ...
        if (this.withdrawDetails != null) {
            properties.put("withdrawDetails", this.withdrawDetails.stream().map(v -> v.properties(
