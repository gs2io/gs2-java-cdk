...
import io.gs2.cdk.money2.model.options.GooglePlayVerifyReceiptEventOptions;
...
public class GooglePlayVerifyReceiptEvent {
    ...
    public GooglePlayVerifyReceiptEvent(
        GooglePlayVerifyReceiptEventOptions options
    ) {
    ...
    public Map<String, Object> properties(
        ...
        if (this.purchaseToken != null) {
            properties.put("purchaseToken", this.purchaseToken);
        }
