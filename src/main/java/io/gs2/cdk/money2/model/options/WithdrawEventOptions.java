...
public class WithdrawEventOptions {
    public List<DepositTransaction> withdrawDetails;
    
    public WithdrawEventOptions withWithdrawDetails(
        List<DepositTransaction> withdrawDetails
    ) {
