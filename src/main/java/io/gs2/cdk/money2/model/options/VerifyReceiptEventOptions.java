...
public class VerifyReceiptEventOptions {
    ...
    public VerifyReceiptEventOptions withAppleAppStoreVerifyReceiptEvent(
    ...
    public VerifyReceiptEventOptions withGooglePlayVerifyReceiptEvent(
