...
public class StoreSubscriptionContentModelTriggerExtendModeIsRollupHourOptions {
    public String metadata;
    public AppleAppStoreSubscriptionContent appleAppStore;
    public GooglePlaySubscriptionContent googlePlay;
    
    public StoreSubscriptionContentModelTriggerExtendModeIsRollupHourOptions withMetadata(
        String metadata
    ) {
    ...
    public StoreSubscriptionContentModelTriggerExtendModeIsRollupHourOptions withAppleAppStore(
    ...
    public StoreSubscriptionContentModelTriggerExtendModeIsRollupHourOptions withGooglePlay(
