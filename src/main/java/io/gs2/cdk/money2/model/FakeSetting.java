...
import io.gs2.cdk.money2.model.options.FakeSettingOptions;
import io.gs2.cdk.money2.model.enums.FakeSettingAcceptFakeReceipt;
...
public class FakeSetting {
    ...
    public Map<String, Object> properties(
        ...
        if (this.acceptFakeReceipt != null) {
            properties.put("acceptFakeReceipt", this.acceptFakeReceipt.toString(
            ));
        }
